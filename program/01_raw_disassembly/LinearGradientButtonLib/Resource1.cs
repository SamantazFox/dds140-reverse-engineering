	...
	internal class Resource1
	{
		...
		internal static ResourceManager ResourceManager
		{
			get
			{
				...
				{
					ResourceManager resourceManager = new ResourceManager("WindowsApplication1.graph.Resource1", typeof(Resource1).Assembly);
		...
		internal static string t
		{
			get
			{
				return Resource1.ResourceManager.GetString("t", Resource1.resourceCulture);
			}
		}

		internal static string TipChann1X
		{
			get
			{
				return Resource1.ResourceManager.GetString("TipChann1X", Resource1.resourceCulture);
			}
		}

		internal static string TipChann2X
		{
			get
			{
				return Resource1.ResourceManager.GetString("TipChann2X", Resource1.resourceCulture);
			}
		}

		internal static string TipChannVisible
		{
			get
			{
				return Resource1.ResourceManager.GetString("TipChannVisible", Resource1.resourceCulture);
			}
		}
		...
		internal static string TipLissajour
		{
			get
			{
				return Resource1.ResourceManager.GetString("TipLissajour", Resource1.resourceCulture);
			}
		}

		internal static string TipSaveText
		{
			get
			{
				return Resource1.ResourceManager.GetString("TipSaveText", Resource1.resourceCulture);
			}
		}

		internal static string TipScreenShot
		{
			get
			{
				return Resource1.ResourceManager.GetString("TipScreenShot", Resource1.resourceCulture);
			}
		}
